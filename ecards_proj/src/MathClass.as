package  
{
	...
	public class MathClass 
	{
		...
		public function GetAngle($target0:Point, $target1:Point):Number 
		{
			...
			//$_tmp_angle = $_tmp_angle < 0 ? $_tmp_angle + 360 : $_tmp_angle;
		...
		public function GetPos($target0:Point, $target1:Point):Number 
		{
			...
			var $_tmp_x:Number = $target0.x - $target1.x;
			var $_tmp_y:Number = $target0.y - $target1.y;
			var $_tmp_s:Number=Math.sqrt( $_tmp_x * $_tmp_x + $_tmp_y * $_tmp_y );
			return $_tmp_s;
		}
	}
